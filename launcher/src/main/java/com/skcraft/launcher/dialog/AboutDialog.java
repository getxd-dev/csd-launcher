...
public class AboutDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        container.add(new JLabel("<html>You are using modified version of SKCraft Launcher, an open-source customizable<br>" +
                "launcher platform that anyone can use."), "wrap, gapbottom unrel");
        container.add(new JLabel("<html>Heavily modified by Karl, adding the features that original SKCraft Launcher<br>" +
                "doesn't have."), "wrap, gapbottom unrel");
